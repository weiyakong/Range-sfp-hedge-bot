...
Range SFP Hedge Bot starts as a **TradingView visual analysis project**. The first version provides a Pine Script v5 indicator that helps traders visually study possible Swing Failure Pattern (SFP) reactions around important BTC levels.
...
- Shows possible bullish and bearish SFP labels when price sweeps a level and reclaims it.
...
Real exchange execution is not part of version 0.1.
