...
Exchange testnet support should come only after the indicator and paper trading logic are validated. Real trading and real exchange execution are not part of version 0.1.
